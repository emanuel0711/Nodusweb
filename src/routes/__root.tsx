...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gerencie o catálogo de produtos e gere a planilha do clube de ofertas automaticamente, com cruzamento inteligente de descrições, EAN e imagens." },
      { name: "author", content: "OfertaFlow" },
      { property: "og:title", content: "OfertaFlow — Automação de ofertas de supermercado" },
      { property: "og:description", content: "Gerencie o catálogo de produtos e gere a planilha do clube de ofertas automaticamente, com cruzamento inteligente de descrições, EAN e imagens." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "OfertaFlow — Automação de ofertas de supermercado" },
      { name: "twitter:description", content: "Gerencie o catálogo de produtos e gere a planilha do clube de ofertas automaticamente, com cruzamento inteligente de descrições, EAN e imagens." },
